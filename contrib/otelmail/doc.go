// Package otelmail provides OpenTelemetry tracing middleware for the go-email library.
//
...
// Go module, the core go-email library stays dependency-free — users who do
